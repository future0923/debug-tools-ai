...
codex_only_files=(
  ".codex/skills/debug-tools-mcp/SKILL.md"
  ".codex/plugins/debug-tools-ai/.codex-plugin/plugin.json"
  ".codex/plugins/debug-tools-ai/skills/debug-tools-mcp/SKILL.md"
)
...
required_installed=(
  ...
  ".claude/plugins/debug-tools-ai/skills/debug-tools-mcp/SKILL.md"
  ...
  ".cursor/plugins/debug-tools-ai/skills/debug-tools-mcp/SKILL.md"
  ".kimi/debug-tools-ai/AGENTS.md"
  ".kimi/plugins/debug-tools-ai/.kimi-plugin/plugin.json"
  ".kimi/plugins/debug-tools-ai/skills/debug-tools-mcp/SKILL.md"
  ".pi/packages/debug-tools-ai/package.json"
  ".pi/packages/debug-tools-ai/bin/debug-tools-ai"
  ".pi/packages/debug-tools-ai/skills/debug-tools-mcp/SKILL.md"
)
...
grep -q "debug-tools-mcp" "$TMP_HOME/.codex/skills/debug-tools-mcp/SKILL.md"
grep -q "generate_method_args_template" "$TMP_HOME/.config/opencode/debug-tools-ai/skills/debug-tools-mcp/SKILL.md"
...
expected_skill = home / ".config/opencode/debug-tools-ai/skills/debug-tools-mcp/SKILL.md"
