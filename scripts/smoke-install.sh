...
codex_only_files=(
  ...
  ".codex/skills/debug-tools-spring-config/SKILL.md"
  ...
  ".codex/plugins/debug-tools-ai/skills/debug-tools-spring-config/SKILL.md"
)
...
required_installed=(
  ...
  ".claude/plugins/debug-tools-ai/skills/debug-tools-spring-config/SKILL.md"
  ...
  ".gemini/extensions/debug-tools-ai/skills/debug-tools-spring-config/SKILL.md"
  ...
  ".config/opencode/debug-tools-ai/skills/debug-tools-spring-config/SKILL.md"
  ...
  ".cursor/plugins/debug-tools-ai/skills/debug-tools-spring-config/SKILL.md"
  ...
  ".kimi/plugins/debug-tools-ai/skills/debug-tools-spring-config/SKILL.md"
  ...
  ".pi/packages/debug-tools-ai/skills/debug-tools-spring-config/SKILL.md"
)
...
grep -q "/spring/config" "$TMP_HOME/.config/opencode/debug-tools-ai/skills/debug-tools-spring-config/SKILL.md"
...
grep -q "Spring Config HTTP" <<<"$pressure_output"
...
expected_spring_config_skill = home / ".config/opencode/debug-tools-ai/skills/debug-tools-spring-config/SKILL.md"
if not expected_spring_config_skill.exists():
    raise SystemExit(f"OpenCode installed skill missing: {expected_spring_config_skill}")
PY
